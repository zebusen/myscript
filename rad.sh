...
git remote add zebu3 https://github.com/Pzqqt/android_kernel_xiaomi_whyred.git
git fetch --shallow-since=2021-01-17 zebu3
git cherry-pick ad76c7f5594e2175ef1317fe15c4f36d1d9b6669
